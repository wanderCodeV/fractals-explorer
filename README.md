...
- Barnsley fern, Vicsek fractal, and Hilbert curve
...
- When the animation is running, Mandelbrot repeatedly dives to a very deep zoom (about `1e-10` of the starting view) while rotating, then starts another dive.
- Press `Space` to freeze the automatic effect, then use dragging and controls manually.
- The settings panel is unavailable in Mandelbrot mode.
