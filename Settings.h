...
struct Settings
{
    ...
    // Koch curve
    sf::Vector2f koch_p1 = { 400, 280 };
    sf::Vector2f koch_p2 = { 1200, 280 };

    // Sierpinski triangle
    sf::Vector2f sierpinski_p1 = { 800, 110 };
    sf::Vector2f sierpinski_p2 = { 200, 840 };
    sf::Vector2f sierpinski_p3 = { 1400, 840 };

    // Fractal tree
    sf::Vector2f tree_start = { 800, 620 };
    ...
    float settingsPanelX;
    float settingsPanelY;
    float settingsButtonSize = 30;

    Settings()
    {
        // Calculate settings panel position based on window size
        settingsPanelX = windowWidth - settingsPanelWidth - 20.0f;
        settingsPanelY = windowHeight - settingsPanelHeight - 20.0f;
